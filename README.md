...
To redirect all YouTube links to Piped, you are highly recommended to use either [Piped-Redirects](https://github.com/ShrithikShahapure/Youtube-To-Piped_Converter) or [Libredirect](https://github.com/libredirect/libredirect#readme).
